...
export default function ProjectMenuItem({ project, active, onSelect }: Props) {
  ...
  return (
    <button
      ...
      className={`relative pl-10 pr-4 md:px-14 xl:px-24 py-3 w-full text-left transition-opacity duration-300 ${
        active
    ...
    >
      <div>
        <IconComponent className="absolute left-4 top-1/2 dark:fill-white -translate-y-1/2 h-10 w-10 bg-center bg-no-repeat bg-[length:75%_75%]" />
